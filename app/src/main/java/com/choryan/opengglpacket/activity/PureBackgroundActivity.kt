 ...
 * @date: 2021/6/22
 */
class PureBackgroundActivity : BaseActivity(R.layout.activity_pure_background) {
    ...
    private fun initView() {
        ...
        val render = PureBackgroundRender()
    ...
    companion object {
        fun startActivity(context: Context) {
            try {
                val intent = Intent(context, PureBackgroundActivity::class.java)
