 ...
 * @date: 2021/6/23
 */
public class DrawBitmapSobelRender implements GLSurfaceView.Renderer {
    ...
    public DrawBitmapSobelRender(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        String vertexShaderStr = AssetsUtils.getVertexStrFromAssert(BaseApplication.instance, "vertex_draw_bitmap_sobel_shader");
        String fragmentShaderStr = AssetsUtils.getFragmentStrFromAssert(BaseApplication.instance, "fragment_draw_bitmap_sobel_shader");
